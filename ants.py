...
class Ant(Insect):
    ...
    #added function to use in the Place class to avoid error
...
class FireAnt(Ant):
    ...
    "*** YOUR CODE HERE ***"
    food_cost = 4
    implemented = True #changed to True after implementing FireAnt methods
...
class LongThrower(ThrowerAnt):
    ...
    min_range = 4
    max_range = 10
    implemented = True #changed upon completion of sub-class
...
class WallAnt(Ant):
    ...
    name = 'Wall'
    "*** YOUR CODE HERE ***"
    implemented = True #changed upon implementation
    food_cost = 4
...
class ScubaThrower(ThrowerAnt):
    ...
    name = 'Scuba'
    "*** YOUR CODE HERE ***"
    implemented = True #changed upon completion
    food_cost = 5
    watersafe = True
